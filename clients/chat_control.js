...
(function () {
  ...
  const MAPPINGS = {
    Format: {
      Concise: 'Answer as concise as possible',
      'Step-by-step': 'Think step-by-step',
      'Extreme Detail': 'Answer in painstakingly detail',
      ELI5: "Explain like I'm five",
      Essay: 'Answer in Essay format',
      Report: 'Answer in Report format',
      Summary: 'Answer in Summary format',
      Table: 'Answer in Table format',
      FAQ: 'Answer in FAQ format',
      Listicle: 'Answer in Listicle format',
      Interview: 'Answer in Interview format',
      Review: 'Answer in Review format',
      News: 'Answer in News format',
      Opinion: 'Answer in Opinion format',
      Tutorial: 'Answer in Tutorial format',
      'Case Study': 'Answer in Case Study format',
      Profile: 'Answer in Profile format',
      Blog: 'Answer in Blog format',
      Poem: 'Answer in Poem format',
      Script: 'Answer in Script format',
      Whitepaper: 'Answer in Whitepaper format',
      eBook: 'Answer in eBook format',
      'Press Release': 'Answer in Press Release format',
      Infographic: 'Answer in Infographic format',
      Webinar: 'Answer in Webinar format',
      'Podcast Script': 'Answer in Podcast Script format',
      'Email Campaign': 'Answer in Email Campaign format',
      'Social Media Post': 'Answer in Social Media Post format',
      Proposal: 'Answer in Proposal format',
      Brochure: 'Answer in Brochure format',
      Newsletter: 'Answer in Newsletter format',
      Presentation: 'Answer in Presentation format',
      'Product Description': 'Answer in Product Description format',
      'Research Paper': 'Answer in Research Paper format',
      Speech: 'Answer in Speech format',
      Memo: 'Answer in Memo format',
      'Policy Document': 'Answer in Policy Document format',
      'User Guide': 'Answer in User Guide format',
      'Technical Documentation': 'Answer in Technical Documentation format',
      'Q&A': 'Answer in Q&A format',
    },
    Tone: {
  ...
  async function initialize() {
    ...
    console.log(
      'Features: $-command (with context), @-menu (with context), /-menu (anywhere, no context preservation)'
    );
  ...
  function patchNativeMenus() {
    const observer = new MutationObserver(() => {
      ...
      const isAgentMenu = agentOptions.some(
        (opt) => opt.textContent.includes('GPT') || opt.textContent.includes('Claude')
      );
      if (isAgentMenu) {
